...
|--------------------|----------------|--------------------|-------------------------|
| Наивная реализация | O(n)         | \[O(1)\]               | O(n² + m)           |
...
\[1 + (CountTrees + 1 + 2 * CountMarked) - (CountTrees - 2 * CountMarked)  = 2 = O(1)\]
