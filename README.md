...
* [*Алгоритм Дейкстры и использованием Фибоначчиевой кучи*](#) <br/>
...
<strong id="lemma-1">Лемма 1</strong> <br/>
...
<strong id="lemma-2">Лемма 2</strong> <br/>
...
___Переход:___
$$F_n=F_{n-1}+F_{n-2}=\frac{φ^{n-1}-(-φ)^{1-n}}{\sqrt{5}}+\frac{φ^{n-2}-(-φ)^{2-n}}{\sqrt{5}}=\frac{1}{\sqrt{5}}(φ^{n-1}-(-φ)^{1-n}+φ^{n-2}-(-φ)^{2-n})=\frac{1}{\sqrt{5}}(φ^n(φ^{-1}+φ^{-2})-(-φ)^{-n}(-φ+φ^{2}))$$
...
<strong id="lemma-4">Лемма 4</strong> <br/>
